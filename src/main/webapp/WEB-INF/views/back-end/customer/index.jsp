                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <div class="right__formWrapper">
                                ...
                                <a style="float:left;margin-left:350px;" href="${pageContext.request.contextPath }/customer/update/${user.id}"><button style="padding: 0 20px;" class="btn">Cập nhật thông tin</button></a>
                                <a style="float:right; margin-right:350px;" href="${pageContext.request.contextPath }/customer/password"><button style="padding: 0 20px;"class="btn">Đổi mật khẩu</button></a>

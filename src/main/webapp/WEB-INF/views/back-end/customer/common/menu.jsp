	...
	<div class="left">
                    ...
                    <div class="left__content">
                        ...
                        <ul class="left__menu">
                            ...
                            <li class="left__menuItem">
                                <a href="${pageContext.request.contextPath}/customer/my-orders" class="left__title"><img src="${pageContext.request.contextPath}/assets/icon-book.svg" alt="">Đơn hàng</a>
                            </li>
                            <li class="left__menuItem">
